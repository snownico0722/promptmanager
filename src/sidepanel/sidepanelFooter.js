...
export function mountSidepanelFooter({ active = null, root = document.body } = {}) {
  ...
  footer.innerHTML = `
    <div class="footer-icons">
      <a class="footer-icon-link${active === 'opd' ? ' footer-icon-link-active' : ''}" data-footer-page="opd" href="${prefix}opd-settings.html" data-i18n-title="opd.title" title="Open Prompt Database">
      ...
      <a class="footer-icon-link" href="https://github.com/jonathanbertholet/promptmanager" target="_blank" rel="noopener" data-i18n-title="support.githubTitle" title="Github">
      ...
      <a class="footer-icon-link" href="https://buymeacoffee.com/jonathanbertholet" target="_blank" rel="noopener" data-i18n-title="support.coffeeTitle" title="Buy me a coffee">
      ...
      <a class="footer-icon-link" href="https://chromewebstore.google.com/detail/open-prompt-manager/gmhaghdbihgenofhnmdbglbkbplolain" target="_blank" rel="noopener" data-i18n-title="support.reviewTitle" title="Review me">
